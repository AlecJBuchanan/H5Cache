cacheMain: ./src/main/h5main.c ./src/main/h5cache.c ./src/main/h5chunks.c ./src/main/shmMain.c
	gcc `pkg-config --cflags glib-2.0` -lpthread ./src/main/h5main.c ./src/main/h5cache.c ./src/main/h5chunks.c ./src/main/shmMain.c -o ./bin/main/main `pkg-config --libs glib-2.0` -I/mnt/common/abuchan1/code/h5cache/includes/ -L/mnt/common/abuchan1/code/h5cache/lib -lhdf5 
